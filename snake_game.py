...
class SnakeGame:
    ...
    def show_gameover(self):
        ...
        self.display.blit(
            score_text, (self.w/2 - score_text.get_width()/2, 120)
            )
        self.display.blit(
            time_text, (self.w/2 - time_text.get_width()/2, 150)
        )
        ...
        if self.scores:
            ...
            for i, score in enumerate(self.scores[:5]):
                ...
                self.display.blit(
                    score_text,
                    (self.w/2 - score_text.get_width()/2, 230 + i*30))
    ...
    def _update_ui(self):
        ...
        for point in self.snake:
            pygame.draw.rect(
                self.display,
                BLUE, pygame.Rect(point.x, point.y, BLOCK_SIZE, BLOCK_SIZE)
            )
            pygame.draw.rect(
                self.display,
                BLUE_LIGHT, pygame.Rect(point.x+4, point.y+4, 12, 12)
            )
        ...
        for apple in self.green_apples:
            pygame.draw.rect(
                self.display,
                GREEN,
                pygame.Rect(apple.x, apple.y, BLOCK_SIZE, BLOCK_SIZE)
            )
